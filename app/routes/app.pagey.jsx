...
export default function AddURLsPage() {
  ...
  return (
    <s-page>
      ...
      <s-button slot="secondary-actions" onClick={handleImportFromFile}>
        Import from File
      </s-button>
      ...
      <s-section heading="Add URLs for Indexing">
        <s-stack gap="base" direction="vertical">
          <s-paragraph>
            Enter the URLs you want to submit for indexing. Each URL should be
            on a separate line. Make sure URLs are properly formatted (e.g.,
          ...
          <s-stack gap="small-200" direction="inline">
            ...
            <s-button onClick={handleValidateURLs} disabled={urlCount === 0}>
              Validate URLs
            </s-button>
            <s-button
              variant="tertiary"
        ...
        >
          ...
          >
            <s-stack gap="small-200" direction="vertical">
              ...
              <s-text size="small">
                Search engines favor rich media and improve your page's
                discovery rate.
              </s-text>
            </s-stack>
          </s-box>
