  ...
  return (
    <s-section padding="none">
      {items.map(({ title, id, content }) => {
        ...
        return (
          <s-box key={id} borderWidth="small" borderColor="border">
            <s-clickable
              onClick={() => {
...
const ACCORDION_ITEMS = [
  {
    ...
    content: (
      <s-text>
        ...
        saepe minima nesciunt impedit quaerat repellat eveniet, dignissimos quis
        quo sed maxime aspernatur qui, quod consectetur optio veritatis iusto
        eligendi?
      </s-text>
    ),
  },
